      ...
      <div v-for="item in items" :key="item.gameId" class="flex items-center justify-between w-full h-[88px] my-2 bg-yellow-100 rounded-[10px] border-4 border-black">
        <div class="flex items-center">
          ...
          <div class="flex items-center">
            ...
            <div v-if="item.playerGame1?.playerID === username" :class="['text-black', 'text-sm', 'md:text-md', 'lg:text-lg', 'font-bold', 'inline-block', 'mr-2', 'rounded', 'p-1.5', item.playerGame1?.winner ? 'bg-green-500' : 'bg-red-500']">
